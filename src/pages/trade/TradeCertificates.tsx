...
export const TradeCertificates: React.FC = () => {
  ...
  const [isCustomImporter, setIsCustomImporter] = useState(false);
                      ...
                      <select
                        ...
                        onChange={(e) => {
                          if (e.target.value === '__CUSTOM__') {
                            setIsCustomImporter(true);
                            setNewCert({ ...newCert, importer: '' });
                          } else {
                            setNewCert({ ...newCert, importer: e.target.value });
                          }
                        }}
