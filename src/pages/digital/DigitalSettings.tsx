      ...
      <div className="flex flex-col items-center justify-center min-h-[60vh] gap-6 text-center">
        ...
        <div className="space-y-2">
          ...
          <p className="text-sm font-semibold text-slate-500 max-w-sm">
            Agency settings are only accessible to Digital Administrators. Contact your admin to make configuration changes.
          </p>
        </div>
        <div className="px-4 py-2 bg-amber-50 border border-amber-200 rounded-xl">
          <span className="text-xs font-extrabold text-amber-700 uppercase tracking-wider">Staff Role — Read-Only Access</span>
        </div>
      </div>
    );
  }
