...
import { CheckCircle2, Eye, EyeOff, Shield, Mail, Phone, Building, Calendar, MapPin, Award, Sparkles, Star } from 'lucide-react';
...
export const StaffProfile: React.FC = () => {
  ...
  return (
    <div className="space-y-8 text-left antialiased select-none">
      ...
      <div className="rounded-3xl bg-gradient-to-r from-[#58051E] via-[#430316] to-[#2E030F] text-white p-8 shadow-xl relative overflow-hidden flex flex-col md:flex-row md:items-center justify-between gap-6">
          ...
          <div className="space-y-1">
            <div className="flex items-center gap-2">
              ...
              <span className="flex items-center gap-1 text-[10px] font-bold text-amber-300">
                <Star className="w-3 h-3 fill-amber-300 text-amber-300" /> 98.4% Exceptional SLA Score
              </span>
            </div>
        ...
        <div className="space-y-6">
          <Card className="p-5 border border-slate-200/80 shadow-xs space-y-3">
            <h3 className="text-xs font-black uppercase text-slate-900 tracking-wider flex items-center gap-1.5">
              <Award className="w-4 h-4 text-[#58051E]" /> Verified Skills & Competencies
            </h3>
            <div className="flex flex-wrap gap-1.5">
              {['UKVI CAS Filing', 'Canada SDS Portal', 'IELTS Score Verification', 'SOP Writing Audit', 'Bank Solvency Verification', 'VFS Biometric Prep'].map((skill, idx) => (
                <span key={idx} className="text-[10.5px] font-bold bg-slate-100 text-slate-800 px-2.5 py-1 rounded-xl border border-slate-200 flex items-center gap-1">
        ...
        <div className="lg:col-span-2 space-y-6">
          <Card className="p-6 border border-slate-200/80 shadow-xs space-y-4">
            ...
            <div className="grid grid-cols-1 sm:grid-cols-2 gap-4 text-xs font-semibold text-slate-700">
              <div className="p-3.5 bg-slate-50 rounded-2xl border border-slate-100 space-y-1">
                ...
                <span className="font-bold text-slate-900 flex items-center gap-1.5"><Mail className="w-3.5 h-3.5 text-[#58051E]" /> staff.education@ferex.com</span>
              </div>

              <div className="p-3.5 bg-slate-50 rounded-2xl border border-slate-100 space-y-1">
                <span className="text-[10px] font-extrabold uppercase text-slate-400 block">Phone Number</span>
                <span className="font-bold text-slate-900 flex items-center gap-1.5"><Phone className="w-3.5 h-3.5 text-[#58051E]" /> +91 98765 43210</span>
              </div>

              <div className="p-3.5 bg-slate-50 rounded-2xl border border-slate-100 space-y-1">
                <span className="text-[10px] font-extrabold uppercase text-slate-400 block">Reporting Manager</span>
                <span className="font-bold text-slate-900 flex items-center gap-1.5"><Building className="w-3.5 h-3.5 text-[#58051E]" /> Ananya Sharma (Central Director)</span>
              </div>

              <div className="p-3.5 bg-slate-50 rounded-2xl border border-slate-100 space-y-1">
                <span className="text-[10px] font-extrabold uppercase text-slate-400 block">Joining Date</span>
                <span className="font-bold text-slate-900 flex items-center gap-1.5"><Calendar className="w-3.5 h-3.5 text-[#58051E]" /> Jan 15, 2024</span>
              </div>
              ...
              <div className="p-3.5 bg-slate-50 rounded-2xl border border-slate-100 space-y-1 sm:col-span-2">
                ...
                <span className="font-bold text-slate-900 flex items-center gap-1.5"><MapPin className="w-3.5 h-3.5 text-[#58051E]" /> FEREX International HQ — Bengaluru, Karnataka</span>
              </div>
            </div>
          </Card>
          ...
          <Card className="p-6 border border-slate-200/80 shadow-xs space-y-4">
            <h3 className="text-sm font-black text-slate-900 border-b border-slate-100 pb-2 flex items-center gap-2">
              <Shield className="w-4 h-4 text-[#58051E]" /> UI Demo Credentials (Read-Only UI Display)
            </h3>

            <div className="grid grid-cols-1 sm:grid-cols-2 gap-4 text-xs font-semibold">
              <div className="p-3.5 bg-slate-50 rounded-2xl border border-slate-100 space-y-1">
                <span className="text-[10px] font-extrabold uppercase text-slate-400 block">Demo Official Email</span>
                <span className="font-mono font-black text-[#58051E]">staff.education@ferex.com</span>
              </div>
