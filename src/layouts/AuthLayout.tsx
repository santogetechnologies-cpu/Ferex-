...
export const AuthLayout: React.FC<AuthLayoutProps> = ({ children }) => {
  return (
    <div className="min-h-screen w-full flex flex-col lg:flex-row bg-slate-50 antialiased font-sans overflow-x-hidden">
      {/* ── LEFT SIDE (45%): Official FEREX Wine Brand Panel ────────────── */}
      <div className="w-full lg:w-[45%] min-h-[300px] lg:min-h-screen bg-[#58051E] relative flex items-center justify-center p-8 overflow-hidden shrink-0 shadow-2xl">
        ...
        >
          ...
          <p className="text-xs font-bold text-white/80 tracking-widest uppercase pt-2">
      ...
      <div className="w-full lg:w-[55%] flex-1 flex flex-col justify-center items-center p-6 sm:p-10 md:p-12 lg:p-16 xl:p-24 bg-white relative">
        <motion.div
          ...
          className="w-full max-w-md lg:max-w-[540px] xl:max-w-[560px] bg-white border border-slate-200 rounded-[28px] shadow-2xl shadow-slate-200/60 p-8 sm:p-12 text-left relative z-10 transition-all duration-300"
        >
          {children}
        </motion.div>
      </div>
